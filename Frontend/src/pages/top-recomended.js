...
import topRecom from './../top-recom.jpg';
...
export default class TopRecomended extends Component {
    ...
    componentDidMount() {
        ...
        const url = 'http://ec2-54-153-46-53.us-west-1.compute.amazonaws.com/:5000/api/recipes/popular';
        axios.get(url)
            .then(response => {
                                            ...
                                            <div className="recipe-card-img-wrapper">
                                                <div>
                                                    {recipe.image ? (
                                                        ...
                                                        <div>
                                                            <img alt={recipe.title} src={topRecom} className="recipe-card-img placeholder" width="220" height="220"/>
                                                            <img alt={recipe.title} src={topRecom} className="recipe-card-img full" width="220" height="220"/>
                                                        </div>
                                                    )}
                                                </div>
